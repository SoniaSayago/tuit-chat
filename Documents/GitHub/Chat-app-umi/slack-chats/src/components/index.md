...
export default () => {
  const menuHeaderDropdown = (
    <Menu selectedKeys={[]}>
      <Menu.Item key="center">Your Profile</Menu.Item>
...
export default () => {
  return (
    <HeaderSearch
      ...
      defaultValue="umi ui"
      options={[
        { label: 'New channel', value: 'New channel' }
      ]}
      onSearch={(value) => {
...
<Space>
  <HeaderSearch
    ...
    defaultValue="create new channel"
    options={[
      { label: <a href="https://github.com/SoniaSayago/tuit-chat">create new channel</a>, value: 'create new channel' },
      {
        label: <a href="next.ant.design">welcome</a>,
        value: 'welcome',
      },
      {
